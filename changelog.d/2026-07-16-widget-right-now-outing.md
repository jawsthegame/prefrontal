- **iOS/watch: an active outing leads "Right Now"** ✅ — when you're mid-outing,
  the surfaces that answer "what's in front of me right now" now say so instead of
  skipping to the next todo. On the phone's main glance (medium), the **RIGHT NOW**
  column leads with the active outing (its intention + a one-tap **I'm back**),
