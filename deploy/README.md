...
| `n8n/hyperfocus-check.workflow.json` | Hyperfocus: every-minute poll of `/webhooks/focus/check` → Pushover for due interrupts (normal for the `check` overrun nudge, high-priority for the `break` biological-break). | deployment §8 |
