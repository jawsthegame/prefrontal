...
| Focus balance (trip life-domains) | `prefrontal/focus_balance.py` | ✅ Rolls out-of-home trip time up by life-sphere (shop/work/home/personal) over a week — `GET /balance`, `prefrontal balance`, a briefing line + profile section; opt-in weekly "light on home/personal" nudge gated on per-domain targets the **Parent pack** seeds |
...
# Where did the week's out-of-home time go? (shop/work/home/personal)
