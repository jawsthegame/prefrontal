...
| Implementation Intentions | `implementation_intention` | Pre-committed *if-then* plans (a cue — a place and/or time-of-day band — paired with a tiny pre-decided action) surfaced the moment their cue is detected, offloading task initiation onto the cue. Capture in one utterance ("when I sit at my desk after lunch, open the tax form"); forgiving (no streak/guilt) |
